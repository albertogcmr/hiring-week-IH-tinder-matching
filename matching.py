...
def main(): 
    ...
    bootcamp, companies_filename, students_filename, n_rondas, min_interviews_per_company = get_args()
    ...
    lista_interviews = get_rondas(lista_matching, n_rondas, students.index, companies.index, min_interviews_per_company)
